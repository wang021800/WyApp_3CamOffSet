...
namespace WY_App.Utility
{
    public class Halcon
    {
        ...
        public static void SetFramegrabberParam(int i,HTuple hv_AcqHandle)
        {
            ...
            HOperatorSet.SetFramegrabberParam(hv_AcqHandle, "ExposureTime", Parameters.cameraParam.CamShutter[0]); HOperatorSet.SetFramegrabberParam(hv_AcqHandle, "[Interface]CameraType", "LineScan");
